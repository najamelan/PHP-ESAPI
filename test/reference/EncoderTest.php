...
class EncoderTest extends PHPUnit_Framework_TestCase
{
    ...
    public function testCanonicalize()
    {
        ...
        $this->assertEquals("\0", $instance->canonicalize("\\0"));
        $this->assertEquals("".chr(0x08), $instance->canonicalize("\\b"));
        $this->assertEquals("\t", $instance->canonicalize("\\t"));
        $this->assertEquals("\n", $instance->canonicalize("\\n"));
        $this->assertEquals("".chr(0x0b), $instance->canonicalize("\\v"));
        $this->assertEquals("".chr(0x0c), $instance->canonicalize("\\f"));
        $this->assertEquals("\r", $instance->canonicalize("\\r"));
        $this->assertEquals("'", $instance->canonicalize("\\'"));
        $this->assertEquals("\"", $instance->canonicalize("\\\""));
        $this->assertEquals("\\", $instance->canonicalize("\\\\"));
        $this->assertEquals("<", $instance->canonicalize("\\<"));
